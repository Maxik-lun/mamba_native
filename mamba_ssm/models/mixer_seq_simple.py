...
from ..ops.layernorm import RMSNorm, layer_norm_fn, rms_norm_fn
...
def create_block(
    ...
    if layer_idx not in attn_layer_idx:
        ...
        if ssm_layer not in ["Mamba1",]:
            raise ValueError(f"Invalid ssm_layer: {ssm_layer}, only support Mamba1")
        mixer_cls = partial(
            Mamba,
            layer_idx=layer_idx,
            **ssm_cfg,
